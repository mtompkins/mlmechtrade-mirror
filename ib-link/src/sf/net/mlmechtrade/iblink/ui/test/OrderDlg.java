...
public class OrderDlg extends JDialog {
	...
	public OrderDlg(SampleFrame owner) {
		...
		addGBComponent(pOrderDetails, m_orderType, gbc, COL2_WIDTH,
				GridBagConstraints.REMAINDER);
		addGBComponent(pOrderDetails, new JLabel("Lmt Price"), gbc, COL1_WIDTH,
				GridBagConstraints.RELATIVE);
		addGBComponent(pOrderDetails, m_lmtPrice, gbc, COL2_WIDTH,
				GridBagConstraints.REMAINDER);
		addGBComponent(pOrderDetails, new JLabel("Aux Price"), gbc, COL1_WIDTH,
				GridBagConstraints.RELATIVE);
	...
	void onSharesAlloc() {
		...
		// SharesAllocDlg dlg = new SharesAllocDlg( this,
		// m_parent.m_FAAcctCodes);
