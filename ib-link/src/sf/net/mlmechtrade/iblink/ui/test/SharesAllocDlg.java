...
public class SharesAllocDlg extends JDialog {
	...
	public SharesAllocDlg(OrderDlg owner, String acctCodes) {
		...
		m_txtSharesAllocation.setMaximumSize(m_txtSharesAllocation
				.getPreferredSize());
		...
		sharesDisplayPanel.setBorder(BorderFactory
				.createTitledBorder("Shares Allocation Details"));
	...
	void onAddShareAlloc() {
		...
		if (sharesProfile.trim().length() > 0) {
			m_txtSharesAllocation
					.setText(m_txtSharesAllocation.getText() + ",");
		}
