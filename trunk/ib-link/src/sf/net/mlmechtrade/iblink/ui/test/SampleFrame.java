...
class SampleFrame extends JFrame implements EWrapper {
	...
	public void tickPrice(int tickerId, int field, double price,
		...
		m_tickers
				.add("id="
						...
						+ price
						+ " "
						+ ((canAutoExecute != 0) ? " canAutoExecute"
								: " noAutoExecute"));
	}
	...
	public void tickOptionComputation(int tickerId, int field,
		...
		String toAdd = "id="
				...
				+ ((impliedVol >= 0 && impliedVol != Double.MAX_VALUE) ? Double
						.toString(impliedVol) : "N/A") + " delta = "
				+ ((Math.abs(delta) <= 1) ? Double.toString(delta) : "N/A");
		if (field == TickType.MODEL_OPTION) {
			toAdd += ": modelPrice = "
					+ ((modelPrice >= 0 && modelPrice != Double.MAX_VALUE) ? Double
							.toString(modelPrice)
							: "N/A");
			toAdd += ": pvDividend = "
	...
	public void tickSize(int tickerId, int field, int size) {
		// received size tick
		m_tickers.add("id=" + tickerId + "  " + TickType.getField(field) + "="
				+ size);
	}
	...
	public void orderStatus(int orderId, String status, int filled,
		...
		m_TWS.add("order status: orderId=" + orderId + " clientId=" + clientId
	...
	public void openOrder(int orderId, Contract contract, Order order) {
		// received open order
		m_TWS.add("open order: orderId=" + orderId + " action="
				+ order.m_action + " quantity=" + order.m_totalQuantity
				+ " symbol=" + contract.m_symbol + " type=" + order.m_orderType
				+ " lmtPrice=" + order.m_lmtPrice + " auxPrice="
				+ order.m_auxPrice + " TIF=" + order.m_tif + " localSymbol="
				+ contract.m_localSymbol + " client Id=" + order.m_clientId
				+ " parent Id=" + order.m_parentId + " permId="
				+ order.m_permId + " ignoreRth=" + order.m_ignoreRth
				...
				+ order.m_goodTillDate + " account=" + order.m_account
				+ " allocation=" + order.m_sharesAllocation + " faGroup="
				+ order.m_faGroup + " faMethod=" + order.m_faMethod
				+ " faPercentage=" + order.m_faPercentage + " faProfile="
				+ order.m_faProfile + " shortSaleSlot=" + order.m_shortSaleSlot
				+ " designatedLocation=" + order.m_designatedLocation
				+ " ocaType=" + order.m_ocaType + " rthOnly=" + order.m_rthOnly
				+ " rule80A=" + order.m_rule80A + " settlingFirm="
				+ order.m_settlingFirm + " allOrNone=" + order.m_allOrNone
				+ " minQty=" + order.m_minQty + " percentOffset="
				+ order.m_percentOffset + " eTradeOnly=" + order.m_eTradeOnly
				+ " firmQuoteOnly=" + order.m_firmQuoteOnly + " nbboPriceCap="
				+ order.m_nbboPriceCap + " auctionStrategy="
	...
	public void scannerData(int reqId, int rank,
		...
		m_tickers.add("id = " + reqId + " rank=" + rank + " symbol="
	...
	public void bondContractDetails(ContractDetails contractDetails) {
		...
		m_TWS.add("orderTypes = " + contractDetails.m_orderTypes);
		m_TWS.add("validExchanges = " + contractDetails.m_validExchanges);
		m_TWS.add("nextOptionDate = " + contract.m_nextOptionDate);
		m_TWS.add("nextOptionType = " + contract.m_nextOptionType);
		m_TWS.add("nextOptionPartial = " + contract.m_nextOptionPartial);
		m_TWS.add("notes = " + contract.m_notes);
	...
	public void updateNewsBulletin(int msgId, int msgType, String message,
			String origExchange) {
		String msg;
		msg = " MsgId=" + msgId + " :: MsgType=" + msgType + " :: Origin="
	...
	public void managedAccounts(String accountsList) {
		...
		m_TWS.add("Connected : The list of managed accounts are : ["
				+ accountsList + "]");
	}
	...
	public void historicalData(int reqId, String date, double open,
		...
		m_tickers.add("id=" + reqId + " date = " + date + " open=" + open
